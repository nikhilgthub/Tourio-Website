    ...
    <div className="trip">
      ...
      <div className="tripcard">
        <TripData
          ...
          text="Indonesia, officially the Republic of Indonesia (Indonesian: Republik Indonesia), is a country in Southeast Asia and Oceania between the Indian and Pacific oceans.
