...
function AboutUs() {
  return (
    <div className="about-container">
      <h1>Our History</h1>
      <p>
        Tourio is owned and managed by Tourio.In Pvt. LTD, a leading brand in
        web designing services and e-commerce solutions. Tourio.In Pvt. LTD is
        ...
        spirit to reach ahead from our client's expectation.
      </p>
      <h1>Our Mission</h1>
      <p>
      ...
      <h1>Our Vision</h1>
      <p>
        Our Vision is to sow the seeds of par-excellence services with customer
